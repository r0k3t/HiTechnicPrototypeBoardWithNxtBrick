...
<!-- 
    ...
    $File: Compass.xslt $ $Revision: 4 $
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:c="http://schemas.microsoft.com/robotics/2007/07/hitechnic/nxt/compasssensor.html">
  <xsl:import href="/resources/dss/Microsoft.Dss.Runtime.Home.MasterPage.xslt" />

  <xsl:template match="/">
    <xsl:call-template name="MasterPage">
      <xsl:with-param name="title">
        <xsl:text>Hi Technic Compass Sensor - </xsl:text>
      ...
      <xsl:with-param name="description">
        Status of a Hi Technic Compass Sensor.
      </xsl:with-param>
...
function setRotation()
{
  ...
  <xsl:template match="/c:CompassSensorState">
    <img src="/resources/HiTechnic.Y2007.M07/Microsoft.Robotics.Services.Sample.HiTechnic.Resources.HiTechnicCompassSensor.Image.png"
        ...
        <td colspan="2">
          <div style="width:128px;height:128px;background:white;">
            <div id="compass" style="width:128px;height:128px;filter:progid:DXImageTransform.Microsoft.Matrix(FilterType='nearest neighbor');">
              <img src="/resources/HiTechnic.Y2007.M07/Microsoft.Robotics.Services.Sample.HiTechnic.Transforms.Compass.png"
