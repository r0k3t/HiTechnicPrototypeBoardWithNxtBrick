...
<!-- 
    ...
    $File: Motor.user.xslt $ $Revision: 4 $
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:m="http://schemas.microsoft.com/robotics/2007/07/lego/nxt/motor.user.html">
...
setTimeout("startPolling()", 1000);
  ...
  <xsl:template match="/m:MotorState">
    <img src="/resources/User.NxtBrick.Y2007.M07/Microsoft.Robotics.Services.Sample.Lego.Nxt.Resources.NxtMotor.Image.png"
  ...
  filter.Dy = 64 * (1 -  cosTheta - sinTheta);
          ...
          <div style="width:128px;height:128px;background:white;">
            <div id="wheel" style="width:128px;height:128px;filter:progid:DXImageTransform.Microsoft.Matrix(FilterType='nearest neighbor');">
              <img src="/resources/User.NxtBrick.Y2007.M07/Microsoft.Robotics.Services.Sample.Lego.Nxt.Transforms.Wheel.png"
