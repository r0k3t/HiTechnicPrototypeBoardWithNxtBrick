...
<!-- 
    ...
    $File: LightSensor.user.xslt $ $Revision: 5 $
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:ls="http://schemas.microsoft.com/robotics/2007/07/lego/nxt/lightsensor.user.html">
...
setTimeout("startPolling()", 1000);
  ...
  <xsl:template match="/ls:LightSensorState">
    <img src="/resources/User.NxtBrick.Y2007.M07/Microsoft.Robotics.Services.Sample.Lego.Nxt.Resources.NxtLightSensor.Image.png"
