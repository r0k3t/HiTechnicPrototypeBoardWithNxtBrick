...
<!-- 
    ...
    $File: Accelerometer.xslt $ $Revision: 2 $
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:a="http://schemas.microsoft.com/robotics/2007/07/hitechnic/nxt/accelerometer.html"
  ...
  <xsl:template match="/">
    <xsl:call-template name="MasterPage">
      <xsl:with-param name="title">
        <xsl:text>Hi Technic Accelerometer - </xsl:text>
        <xsl:value-of select="/a:AccelerometerState/a:Name"/>
      </xsl:with-param>
      <xsl:with-param name="serviceName">
        Hi Technic Accelerometer
      </xsl:with-param>
      <xsl:with-param name="description">
        Status of a Hi Technic Accelerometer.
      </xsl:with-param>
...
setTimeout("startPolling()", 1000);
  ...
  <xsl:template match="/a:AccelerometerState">
    <img src="/resources/HiTechnic.Y2007.M07/Microsoft.Robotics.Services.Sample.HiTechnic.Resources.HiTechnicAccelerationSensor.Image.png"
